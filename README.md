...
- Генерация портов (100-700) с исключением зарезервированных и занятых
- Автоматическое определение архитектуры роутера и выбор правильного бинарника
- Управление через итерактивное меню (VPS)
- Автоматическая настройка WireGuard через RCI API на роутерах Keenetic
...
- Копирование готовых бинарников wg-obfuscator для VPS сервера и всех поддерживаемых архитектур роутеров (mipsel, mips, aarch64, armv7)
...
### Удаление с роутера Keenetic

Для полного удаления Phobos с роутера:
